...
public class Habitaciones {
    ...
    public void inicio() {
        framehabitaciones = new JFrame("Habitación");//Titulo del JFrame
        framehabitaciones.setSize(500, 400);//Tamaño del JFrame
        framehabitaciones.getContentPane().setBackground(Color.white);
        ...
        lb1 = new JLabel("Habitación");
        lb1.setBounds(20, 15, 200, 50);
        lb1.setVisible(true);

        lb2 = new JLabel("Tipo de habitación");
        ...
        lb6 = new JLabel("Costo Habitación");
        ...
        comboboxtipo.addItem("Sencilla");
        comboboxtipo.addItem("Regular");
        comboboxtipo.addItem("Exclusiva");
